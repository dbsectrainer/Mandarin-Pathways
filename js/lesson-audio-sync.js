...
(function (global) {
    ...
    function appendPhraseSpansToFragment(trimmedPhrase, lang) {
        ...
        if (lang === "en") {
            ...
            parts.forEach((tok) => {
                ...
                const span = document.createElement("span");
                span.className =
                    tok.trim() === "" ? "lesson-space" : "lesson-token";
     ...
     */
    function attachCueHighlighting(
        audioEl,
        timingPhrases,
        getPhraseRootForCue,
    ) {
        ...
        function clearHighlight() {
            ...
            if (lastPhraseEl)
                lastPhraseEl.classList.remove("audio-sync-active");
            lastPhraseEl = null;
            lastTokenEl = null;
        }
        ...
        function refreshAt(timed) {
            ...
            const tokenEl = pickTokenHighlight(
                phraseEl,
                cue.start,
                cue.end,
                timed,
            ...
            if (lastPhraseEl !== phraseEl) {
                if (lastTokenEl)
                    lastTokenEl.classList.remove("audio-sync-reading");
                if (lastPhraseEl)
                    lastPhraseEl.classList.remove("audio-sync-active");
