...
class NotificationManager {
    ...
    setupNotificationPreferences() {
        ...
        if (!preferences) {
            ...
            const defaultPreferences = {
                ...
                nextNotification: this.calculateNextNotificationTime(
                    this.DEFAULT_REMINDER_TIME,
                ),
            };
    ...
    scheduleNextReminder() {
        ...
        if (timeUntilNext > 0) {
            ...
            preferences.nextNotification = this.calculateNextNotificationTime(
    ...
    updateSettings(enabled, reminderTime = this.DEFAULT_REMINDER_TIME) {
        ...
        preferences.nextNotification =
            this.calculateNextNotificationTime(reminderTime);
        this.storePreferences(preferences);
