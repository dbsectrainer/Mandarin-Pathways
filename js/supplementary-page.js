document.addEventListener("DOMContentLoaded", function () {
    ...
    const completedCategories = JSON.parse(
        localStorage.getItem("completedSupplementary") || "{}",
    );
...
function getSectionInfo(category) {
    const info = {
        education: {
            ...
            description:
                "Essential vocabulary and phrases for academic settings.",
        },
        hobbies: {
            title: "Hobbies & Interests",
            description:
                "Express your interests and discuss leisure activities.",
        },
        emotions: {
            title: "Emotions & Feelings",
            description:
                "Communicate feelings and emotional states effectively.",
        },
        daily_life: {
    ...
    return (
        info[category] || {
            ...
            description:
                "Additional learning materials to enhance your Mandarin skills.",
        }
    );
}
