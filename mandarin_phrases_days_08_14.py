...
async def main():
    ...
    print("  - Generate Chinese audio only: python mandarin_phrases_days_08_14.py --language zh")
    print("  - Generate English audio only: python mandarin_phrases_days_08_14.py --language en")
    print("  - Generate with different voice: python mandarin_phrases_days_08_14.py --voice en-US-JennyNeural")
    print("\nAvailable voices:")
