...
async def main():
    ...
    print("  - Generate Chinese audio only: python mandarin_phrases_days_15_22.py --language zh")
    print("  - Generate English audio only: python mandarin_phrases_days_15_22.py --language en")
    print("  - Generate with different voice: python mandarin_phrases_days_15_22.py --voice en-US-JennyNeural")
    print("\nAvailable voices:")
